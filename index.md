...
venue: "Texas A&M University"        # brief name of host site without address (e.g., "Euphoric State University")
address: "405 Annex Library, TAMU"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
helper: ["Jian Tao", "Veronica Ruiz", "James McCann", "Ran Wei"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
eventbrite:  65111863336         # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
